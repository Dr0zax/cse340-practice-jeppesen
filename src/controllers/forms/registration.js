...
const processRegistration = async (req, res) => {
    ...
    if (!savedForm) {
        req.flash('error', 'Failed to save registration form.');
        return res.redirect('/register');
    }
...
export { showRegistrationForm, processRegistration, showAllUsers, registrationValidation, updateAccountValidation,showEditAccountForm, processEditAccount, processDeleteAccount };
